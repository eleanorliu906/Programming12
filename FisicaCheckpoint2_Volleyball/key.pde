...
void handlePlayerInput() {
  ...
  if (wkey && touchGround(leftPlayer, leftGround)) leftPlayer.setVelocity(left_vx, -400);
  ...
  if (upkey && touchGround(rightPlayer, rightGround)) rightPlayer.setVelocity(right_vx, -400);
