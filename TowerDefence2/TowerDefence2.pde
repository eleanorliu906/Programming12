...
// IDEAS
// social distancing for towers
// text pop up when you kill mob / add towers
...
ArrayList<Button> towerButtons = new ArrayList<Button>();
...
void initializeButtons() {
  ...
  AoETowerButton = new Button("AoE", 0.9*width, 0.42*height, 40, 40, lilac, #000000, 0);
  sniperTowerButton = new Button("Sniper", 0.9*width, 0.52*height, 40, 40, pink, #000000, 0);
  sniperTower2Button = new Button("Sniper 2", 0.9*width, 0.62*height, 40, 40, orange2, #000000, 0);
  towerButtons.add(gunTowerButton);
  towerButtons.add(AoETowerButton);
  towerButtons.add(sniperTowerButton);
  towerButtons.add(sniperTower2Button);
