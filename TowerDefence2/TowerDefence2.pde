...
Button basicTowerButton, circleTowerButton, sniperTowerButton;
...
void initializeButtons() {
  ...
  circleTowerButton = new Button(0.87*width, 0.52*height, 40, 40, pink, pink);
  sniperTowerButton = new Button(0.87*width, 0.42*height, 40, 40, lavender, lavender);
  basicTowerButton = new Button(0.87*width, 0.32*height, 40, 40, powderblue, powderblue);
}
